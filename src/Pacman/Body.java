...
public class Body extends JPanel implements ActionListener {
    ...
    private BufferedImage heart, ghost;
    ...
    private void loadImages() {
        try {
            heart = ImageIO.read(getClass().getResourceAsStream("/Pacman/res/heart.png"));
            ghost = ImageIO.read(getClass().getResourceAsStream("/Pacman/res/ghost.gif"));
            right = ImageIO.read(getClass().getResourceAsStream("/Pacman/res/right.gif"));
            left = ImageIO.read(getClass().getResourceAsStream("/Pacman/res/left.gif"));
            up = ImageIO.read(getClass().getResourceAsStream("/Pacman/res/up.gif"));
            down = ImageIO.read(getClass().getResourceAsStream("/Pacman/res/down.gif")); 
        } catch (IOException e) {
            e.printStackTrace();
        }
